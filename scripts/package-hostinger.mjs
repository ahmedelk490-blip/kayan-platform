...
# رابط شاشة دخول النظام. نطاق فرعي من نفس النطاق الأساسي.
# ⚠ لا تضبطه قبل أن يعمل النظام فعلاً: الصفحة تعرض "قيد التجهيز"
#   عند غيابه، وهذا أفضل من زرّ عام يقود إلى عنوان لا يستجيب.
NEXT_PUBLIC_ERP_URL=https://erp.kayan-uniform.com/login
`,
