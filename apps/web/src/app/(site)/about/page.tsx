  ...
  return (
    <>
      <PageHero
        ...
        lead="نخيط ونطبع ونطرّز بمعملنا. تتعامل ويّا الجهة اللي تنفّذ طلبك، مو ويّا واحد يمرّره لغيره."
      />
      ...
      <SectionShell size="tall">
        <div className="mx-auto max-w-[760px] space-y-6 text-[0.95rem] leading-[2] text-body-muted">
          ...
          <p>
            الطباعة والتطريز بنفس المعمل. وهذا مو تفصيل إداري: لمّا يكون
            التنفيذ عدنا، الموعد اللي نعطيك إياه موعد نكدر نلتزم بيه، والتعديل
            على شعارك ما ينتظر دور واحد ثاني.
          </p>
          <p>
            الخامات ننتقيها تتحمّل الغسل المتكرر والشغل اليومي. زي يبهت لونه
            بعد شهر مو أرخص — هو نفس الطلب مرة ثانية.
          </p>
        </div>
      </SectionShell>
      ...
      <SectionShell>
        <div className="rounded-2xl border border-edge-strong bg-panel/70 p-6 md:p-8">
          ...
          <p className="mt-3 text-sm leading-[1.9] text-body-muted">
            ...
            فعلاً، بس ما عدنا صور إلها بالموقع لحد الآن. اطلبها ونرسللك نماذج
            مصوّرة من إنتاجنا.
          </p>
