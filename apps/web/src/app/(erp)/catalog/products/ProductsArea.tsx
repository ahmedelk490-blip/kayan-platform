 ...
 *
 * مكوّن مشترك قابل للتركيب بمسارٍ ومساره الأساسي (`basePath`) الذي يوجّه روابط
 * الصفحة (الترقيم، شرائح التصنيف). يُستعمَل حالياً من قائمة المنتجات داخل قسم
 * «إدارة المنتجات» (`/catalog/products`)، ويبقى `basePath` بارامتراً كي يسهل
 * تركيبه في أي مسار آخر لاحقاً بلا تكرار.
 */
