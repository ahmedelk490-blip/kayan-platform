...
// درجات نبيتيّة فقط — الهوية البصرية لكيان. لا ألوان أخرى: القطاعات تتمايز
// بالفتوح والغمق لا باختلاف اللون.
const PALETTE = ['#5c2334', '#943854', '#c46481', '#7a2d43', '#b05a76', '#d99bae', '#4e1d2c', '#a34860', '#eac8d2', '#3f1824'];
