  ...
  return (
    <SectionShell id="cta" act="Act V" label="The Proof" size="tall">
      <div className="mx-auto w-full max-w-[1400px]">
        <dl className="grid gap-x-8 gap-y-12 border-t border-steel-800 pt-14 sm:grid-cols-2 lg:grid-cols-4">
          {FIGURES.map((figure) => (
            <div key={figure.label}>
              <dd className="font-display text-display-3 leading-none text-steel-100">
                <CountingNumber
                  value={figure.value}
              ...
              <dt className="mt-4 max-w-[24ch] text-sm leading-relaxed text-steel-400">
                {figure.label}
              </dt>
            </div>
          ))}
        ...
        <div className="flex flex-col items-start gap-8 lg:flex-row lg:items-end lg:justify-between">
          <h2 className="max-w-[18ch] font-display text-display-2 leading-[0.98] text-steel-100">
