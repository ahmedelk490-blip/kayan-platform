  ...
  return (
    <SceneAnchor scene="hero" className="relative min-h-[190vh]" offset={['start start', 'end end']}>
      <div id="top" className="sticky top-0 flex h-screen items-center overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_25%,var(--color-ink-950)_78%)]" />
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1400px] px-6 md:px-10 lg:px-16">
          <motion.div
            ...
            className="mb-8 flex items-center gap-3 text-xs uppercase tracking-[0.24em] text-neutral-400"
          >
            <span className="h-px w-10 bg-accent" />
            Enterprise ERP for makers
          </motion.div>

          <h1 className="max-w-[16ch] font-display text-display-1 leading-[0.92] text-neutral-100">
          ...
          <motion.p
            ...
            className="mt-8 max-w-[46ch] text-lead leading-relaxed text-neutral-300"
          >
          ...
          <motion.dl
            ...
            className="mt-16 hidden gap-10 border-t border-ink-800 pt-6 md:flex"
          >
            {[
              ...
              <div key={item.label}>
                ...
                <dd className="mt-1 font-display text-sm text-neutral-200">{item.value}</dd>
              </div>
            ))}
          </motion.dl>
        </div>
        ...
        <motion.div
          ...
          className="absolute inset-x-0 bottom-8 flex flex-col items-center gap-2 text-[0.65rem] uppercase tracking-[0.2em] text-neutral-500"
        >
          <span>Scroll</span>
          <motion.span
