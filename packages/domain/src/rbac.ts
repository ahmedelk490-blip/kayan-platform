...
export const ROLE_PERMISSIONS: Record<RoleKey, PermissionKey[]> = {
  ...
  WAREHOUSE: [
    ...
    // لا صلاحية منتجات البتّة (بطلب المالك بعد التجربة): بطاقة المنتج تحمل
    // سعر الجملة وتسعير البيع، وإدخال المنتجات وتعديلها يبقى بيد المالك وحده.
    // أمين المخزن يسجّل الحركات بالأعداد، ويرى أسماء الأصناف في شاشة المخزون
    // دون أن يفتح بطاقةً أو يعدّل فيها.
